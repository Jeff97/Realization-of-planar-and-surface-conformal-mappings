...
C G is growth tensor
        Lambda1z0 = (1.0+STATEV(1)**2+STATEV(2)**2)/
     &    (2.0*(STATEV(1)**2+STATEV(2)**2))
        Lambda1z1 = -((4.0*STATEV(1)*STATEV(2))/
     &    ((STATEV(1)**2+STATEV(2)**2)*(1+STATEV(1)**2+STATEV(2)**2)))
        Lambda2z0 = Lambda1z0
        Lambda2z1 = -Lambda1z1
        LambdaS   = (2.0*(STATEV(1)**2-STATEV(2)**2))/
     &    ((STATEV(1)**2+STATEV(2)**2)*(1+STATEV(1)**2+STATEV(2)**2))
