...
C G is growth tensor
        ...
        Lambda1z0 = (102+5*U*(2+5*U)+5*V*(2+5*V))/
     &    (4*(2+5*U*(2+5*U)+5*V*(2+5*V)))
        Lambda1z1 = (500*(U-V)*(2+5*U+5*V)*
     &    (-98+10*U+25*U**2+10*V+25*V**2)**3)/
     &    ((2+10*U+25*U**2+10*V+25*V**2)*
     &    (102+10*U+25*U**2+10*V+25*V**2)*
     &    Abs(-98+10*U+25*U**2+10*V+25*V**2)**3)
        Lambda2z0 = Lambda1z0
        Lambda2z1 = -Lambda1z1
        LambdaS = (200*(1+5*U)*(1+5*V)*
     &    (-98+10*U+25*U**2+10*V+25*V**2)**3)/
     &    ((2+10*U+25*U**2+10*V+25*V**2)*
     &    (102+10*U+25*U**2+10*V+25*V**2)
     &    *Abs(-98+10*U+25*U**2+10*V+25*V**2)**3)
...
C G is growth tensor
        ...
        STATEV(7) = G12
        STATEV(8) = G22
        STATEV(9) = Sqrt(G11**2+G12**2+G21**2+G22**2+G33**2)
C
