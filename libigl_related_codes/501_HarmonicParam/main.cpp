...
int main(int argc, char *argv[])
{
  ...
  //igl::read_triangle_mesh("T:/MeshLab-Temp/Model_car.off", V, F);
  igl::read_triangle_mesh("T:/MeshLab-Temp/Alex-Coarse/Alex.off", V, F);
  //igl::read_triangle_mesh("T:/MeshLab-Temp/Sophie/Sophie_Opt.off", V, F);
