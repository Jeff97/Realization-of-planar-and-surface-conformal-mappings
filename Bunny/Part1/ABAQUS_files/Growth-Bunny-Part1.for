...
C
     ...
     &    FOUR=4.D0, SIX=6.D0, NELEMENT=50528)
...
! TODO: please modify path
     ...
     &  'Bunny\part1\F0.CSV',status="old")
        read(302,*) F0
        close(302)

        open(303,FILE='C:\Users\12872\Desktop\'//
     &  'Bunny\part1\G0.CSV',status="old")
        read(303,*) G0
        close(303)

        open(304,FILE='C:\Users\12872\Desktop\'//
     &  'Bunny\part1\L0.CSV',status="old")
        read(304,*) L0
        close(304)

        open(305,FILE='C:\Users\12872\Desktop\'//
     &  'Bunny\part1\M0.CSV',status="old")
        read(305,*) M0
        close(305)

        open(306,FILE='C:\Users\12872\Desktop\'//
     &  'Bunny\part1\N0.CSV',status="old")
        read(306,*) N0
        close(306)
