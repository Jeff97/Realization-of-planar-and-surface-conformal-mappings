...
C
     ...
     &    FOUR=4.D0, SIX=6.D0, NELEMENT=20470)
...
! TODO: please modify path
        ...
        open(301,FILE='F:\Master\Essay\JMPS\Mesh\Alex\'//
     &  'E0.CSV',status="old")
        read(301,*) E0
        close(301)

        open(302,FILE='F:\Master\Essay\JMPS\Mesh\Alex\'//
     &  'F0.CSV',status="old")
        read(302,*) F0
        close(302)

        open(303,FILE='F:\Master\Essay\JMPS\Mesh\Alex\'//
     &  'G0.CSV',status="old")
        read(303,*) G0
        close(303)

        open(304,FILE='F:\Master\Essay\JMPS\Mesh\Alex\'//
     &  'L0.CSV',status="old")
        read(304,*) L0
        close(304)

        open(305,FILE='F:\Master\Essay\JMPS\Mesh\Alex\'//
     &  'M0.CSV',status="old")
        read(305,*) M0
        close(305)

        open(306,FILE='F:\Master\Essay\JMPS\Mesh\Alex\'//
     &  'N0.CSV',status="old")
        read(306,*) N0
        close(306)
