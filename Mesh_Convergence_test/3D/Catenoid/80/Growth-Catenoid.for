...
C G is growth tensor
        ...
        H0=10.0*STATEV(1)+25.0*STATEV(1)**2+10.0*STATEV(2)
     &  +25.0*STATEV(2)**2
        H1=-98.0+H0
        H2=(2.0+H0)*(102+H0)
        Lambda1z0 = (102.0+H0)/(4.0*(2.0+H0))
        Lambda1z1 = (500.0*(STATEV(1)-STATEV(2))*(2.0+5.0*STATEV(1)
     &  +5.0*STATEV(2))*H1**3)/(H2*(ABS(H1)**3))
        Lambda2z0 = Lambda1z0
        Lambda2z1 = -Lambda1z1
        LambdaS = (200.0*(1.0+5.0*STATEV(1))*(1.0+5.0*STATEV(2))
     &  *H1**3)/(H2*(ABS(H1)**3))
        Lambda1=Lambda1z0+STATEV(3)*Lambda1z1
        Lambda2=Lambda2z0+STATEV(3)*Lambda2z1
...
C G is growth tensor
        ...
        STATEV(7) = G12
        STATEV(8) = G21
        STATEV(9)=Sqrt(1+Lambda1**2+Lambda2**2+LambdaS**2)
C
