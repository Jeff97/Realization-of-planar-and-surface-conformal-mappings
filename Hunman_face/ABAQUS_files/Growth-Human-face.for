...
C
     ...
     &    FOUR=4.D0, SIX=6.D0, NELEMENT=135640)
...
! TODO: please modify path
     ...
     &  'Human_face\F0.CSV',status="old")
        read(302,*) F0
        close(302)

        open(303,FILE='C:\Users\12872\Desktop\'//
     &  'Human_face\G0.CSV',status="old")
        read(303,*) G0
        close(303)

        open(304,FILE='C:\Users\12872\Desktop\'//
     &  'Human_face\L0.CSV',status="old")
        read(304,*) L0
        close(304)

        open(305,FILE='C:\Users\12872\Desktop\'//
     &  'Human_face\M0.CSV',status="old")
        read(305,*) M0
        close(305)

        open(306,FILE='C:\Users\12872\Desktop\'//
     &  'Human_face\N0.CSV',status="old")
        read(306,*) N0
        close(306)
