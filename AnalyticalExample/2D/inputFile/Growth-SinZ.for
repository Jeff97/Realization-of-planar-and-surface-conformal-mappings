...
C G is growth tensor
        ! Lambda1z0= 2.718281828459045**(COORDS(1))
        ! Lambda1z1= 0.0
        ! Lambda1=Lambda1z0+STATEV(5)*Lambda1z1
        Lambda1=Sqrt(Cos(2.0*STATEV(3))+Cosh(2.0*STATEV(4)))*Sqrt(2.0)
C
        ! Lambda2z0=2.718281828459045**(COORDS(1))
        ! Lambda2z1=0.0
        ! Lambda2=Lambda2z0+STATEV(5)*Lambda2z1
        Lambda2=Sqrt(Cos(2.0*STATEV(3))+Cosh(2.0*STATEV(4)))*Sqrt(2.0)
